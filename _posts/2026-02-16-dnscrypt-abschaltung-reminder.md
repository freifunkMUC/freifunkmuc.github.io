---
layout: posts
title: "Abschaltung von DNSCrypt - Reminder"
...
Hinweis: Dieser Beitrag wurde bereits am 03.01.2026 veröffentlicht — dies ist eine Erinnerung (Stand: 16.02.2026).
...
## Disabling DNSCrypt
Reminder: This post was originally published on 2026-01-03 — this is a reminder (as of 16 February 2026).
...
Rappel : Cet article a été publié initialement le 03/01/2026 — ceci est un rappel (au 16.02.2026).
...
Recordatorio: Este artículo se publicó originalmente el 03.01.2026 — esto es un recordatorio (a fecha 16.02.2026).
...
## Вимкнення DNSCrypt
Нагадування: Ця публікація була опублікована 03.01.2026 — це нагадування (станом на 16.02.2026).
