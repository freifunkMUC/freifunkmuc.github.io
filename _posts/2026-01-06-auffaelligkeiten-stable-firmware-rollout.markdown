...
Ein Auszug aus der aktuellen Statistik:

| Modell         | Ausgefallen | Erfolgreich | Quote |
| -------------- | ----------- | ----------- | ----- |
| R6120          | 6           | 62          | ~9 %  |
| X1860          | 7           | 30          | ~19 % |
...
Bisher können wir kein eindeutiges Hardware-Pattern erkennen. Auch sind in der Liste einige Geräte dabei, die bereits vor dem Rollout offline waren.

Wir würden die Situation gerne schnell analysieren und freuen uns auf eure Hilfe! 🙏

* Hat jemand ähnliche Effekte bei eigenen Rollouts beobachtet?
