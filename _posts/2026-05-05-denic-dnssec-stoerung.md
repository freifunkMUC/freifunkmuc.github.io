...
**Update:** Wir haben die DNSSEC-Validierung für die .de-Zone wieder eingeschaltet.
...
**Update:** We have re-enabled DNSSEC validation for the .de zone.
...
**Mise à jour :** Nous avons réactivé la validation DNSSEC pour la zone .de.
...
**Actualización:** Hemos reactivado la validación DNSSEC para la zona .de.
...
**Оновлення:** Ми знову увімкнули валідацію DNSSEC для зони .de.
